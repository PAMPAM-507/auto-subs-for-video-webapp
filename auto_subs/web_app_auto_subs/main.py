import os
import pysrt
from .utils.business_logic.subtitles.make_subs import *
from .utils.business_logic.subtitles.put_subs import PutSubs
from .utils.business_logic.subtitles.my_translator import MyTranslator
...
def execute_bs_for_make_subs(path_of_video: str,
    ...
    MyTranslator().make_translate(subtitles, name_of_video)
