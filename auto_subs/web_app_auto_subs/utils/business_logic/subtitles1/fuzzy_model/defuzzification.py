...
class DefuzzificationByHeightMethod(DefuzzificationABC):
    ...
    def execute_defuzzification(rule_base: List[Dict[str, float],], border_for_output_term: List[float]) -> float:
        ...
        values_of_C1, values_of_C2, values_of_C3 = list(map(lambda x: x*border_for_output_term[0], values_of_C1)), list(map(
            lambda x: x*border_for_output_term[1], values_of_C2)), list(map(lambda x: x*border_for_output_term[2], values_of_C3))
    ...
    def calculate_list_of_degrees_of_owned_for_output_parameter(cls, y: float, border_for_output_term: List[float]) -> List[float]:
        ...
        if border_for_output_term[0] <= y <= border_for_output_term[1]:
            list_of_degrees_of_owned_for_output_parameter[0] = (cls.calculate_degree_of_owned(
                y, border_for_output_term[0], border_for_output_term[1]))
        if border_for_output_term[0] <= y <= border_for_output_term[2]:
            list_of_degrees_of_owned_for_output_parameter[1] = cls.calculate_degree_of_owned(
                y, border_for_output_term[1], border_for_output_term[1])
        if border_for_output_term[1] <= y <= border_for_output_term[2]:
            list_of_degrees_of_owned_for_output_parameter[2] = cls.calculate_degree_of_owned(
                y, border_for_output_term[2], border_for_output_term[1])
    ...
    def find_result_of_max_term(cls, y: float, border_for_output_term: List[float]) -> Tuple[Union[str, float]]:
        list_of_degrees_of_owned_for_output_parameter = cls.calculate_list_of_degrees_of_owned_for_output_parameter(
            y, border_for_output_term)
        result = {
    ...
    @classmethod
    def get_resulting_value(cls, rule_base: List[Dict[str, float],], border_for_output_term: List[float]) -> Tuple[str, Union[int, float]]:
